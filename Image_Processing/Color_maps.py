...
def show_with_matplotlib_(color_img, title, pos):
    img_RGB = color_img[:, :, ::-1]
...
show_with_matplotlib_(cv2.cvtColor(gray_img, cv2.COLOR_GRAY2BGR), "gray", 1)
...
show_with_matplotlib_(custom_rand_1, "cv2.applyColorMap()", 2)
show_with_matplotlib_(custom_rand_2, "cv2.LUT()", 3)
show_with_matplotlib_(custom_values_1, "cv2.applyColorMap()", 4)
show_with_matplotlib_(custom_values_2, "cv2.LUT()", 5)
